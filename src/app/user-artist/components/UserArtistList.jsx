...
export default function UserArtistList({ artist }) {
    ...
    async function getData(){
        try{
            const result = await axiosClientAPI.get(`user-artist`, config)
            .then((response) => {
                setData(response.data.data)
                setPrevPage(response.data.links.prev)
                setNextPage(response.data.links.next)
    ...
    async function searchData(){
        console.log(search);
        try{
            const result = await axiosClientAPI.get(`user-artist?search=${search}`, config)
            .then((response) => {
    ...
    const removeData = async () => {
        const artist_id = artistState.item.id;
        try{
              const result = await axiosClientAPI.delete(`user-artist/${artist_id}`, config)
              .then((response) => {
                  getData();
